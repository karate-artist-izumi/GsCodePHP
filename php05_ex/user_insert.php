...
//３．データ登録SQL作成
$sql = "INSERT INTO gs_user_table(name,lid,lpw,img,kanri_flg,life_flg)VALUES(:name,:lid,:lpw,:img,:kanri_flg,0)";
...
$stmt->bindValue(':img', $st, PDO::PARAM_STR); //Integer（数値の場合 PDO::PARAM_INT)::PARAM_STR); //Integer（数値の場合 PDO::PARAM_INT)
